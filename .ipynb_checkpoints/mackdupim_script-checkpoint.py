...
#melhor guardar tudo em um arquivo??





def ImageAugmentation(arg_input_dir,arg_output_dir,arg_output_ext,arg_img_size,arg_color,arg_img_flag_div,arg_img_flag_flip,arg_img_flag_rot,arg_img_flag_lum,arg_img_div,arg_img_rot_max,arg_img_rot_step,arg_img_rot_flag_neg,arg_img_rot_flag_resize,arg_img_lum_max,arg_img_lum_step):

    # Criacao de diretorio de saidaImageAugmentation(arg_input_dir,arg_output_dir,arg_output_ext,arg_img_size,arg_color,arg_img_flag_div,arg_img_flag_flip,arg_img_flag_rot,arg_img_flag_lum,arg_img_div,arg_img_rot_max,arg_img_rot_step,arg_img_rot_flag_neg,arg_img_rot_flag_resize,arg_img_lum_max,arg_img_lum_step)
    ...
    # Duplica as imagens
    for img in tqdm (ic, asc="Loading..."):
    #for img in ic:
...
ImageAugmentation(arg_input_dir,arg_output_dir,arg_output_ext,arg_img_size,arg_color,arg_img_flag_div,arg_img_flag_flip,arg_img_flag_rot,arg_img_flag_lum,arg_img_div,arg_img_rot_max,arg_img_rot_step,arg_img_rot_flag_neg,arg_img_rot_flag_resize,arg_img_lum_max,arg_img_lum_step)